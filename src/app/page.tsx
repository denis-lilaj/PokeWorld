      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className='flex flex-col justify-center'>
          ...
          <div className="mb-8 text-center">
            <h2 className="text-2xl font-semibold text-primary mb-4">Want to check out the teams?</h2>
            <div
            ...
            >
              <h3 className="text-lg font-semibold text-primary">Go to All Teams</h3>
              <p className="text-sm font-semibold text-neutral mt-2">Click here to view and manage all your Poké-teams.</p>
            </div>
          </div>
        </div>
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {pokemons.length === 0 ? (
            <li className="col-span-full text-center p-10 bg-white bg-opacity-20 backdrop-blur-md text-white rounded-lg shadow-xl">
              <p className="text-2xl font-bold mb-4 text-accent">Oops! Failed to catch the Pokémon!</p>
              <p className="text-md font-medium">Try throwing another Poké-name in the search bar.</p>
            </li>
          ) : (
            pokemons.map((pokemon) => (
              ...
              >
                ...
                <p className="text-md font-bold text-neutral">Types: {pokemon.types.join(', ')}</p>
                <Button
