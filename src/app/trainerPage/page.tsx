  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-400 via-yellow-500 to-red-600 text-white">
      ...
      >
        ...
        <h1 className="text-4xl font-bold text-center text-primary mb-6">Poké-teams</h1>
        ...
        <div>
          {teams.length === 0 ? (
            <div className="col-span-full text-center p-10 bg-white bg-opacity-20 backdrop-blur-md text-white rounded-lg shadow-xl">
              <p className="text-2xl font-bold mb-4 text-accent">No Poké-teams created!</p>
              <p className="text-md font-medium">We gotta catch 'em all so start by creating a team.</p>
            </div>
          ) : (
            teams.map((team: Team) => (
              <div
              ...
              >
                <h2 className="text-2xl font-semibold text-primary">{team.name}</h2>
                <Image
                  width={50}
                  height={50}
                  src={pokeball}
